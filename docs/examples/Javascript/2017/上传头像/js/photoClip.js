...
(function(root, factory) {
	...
	if (typeof define === "function" && define.amd) {
		define(["Zepto", "iscroll-zoom", "hammer", "lrz"], factory);
	} else if (typeof exports === "object") {
		module.exports = factory(require("Zepto"), require("iscroll-zoom"), require("hammer"), require("lrz"));
	} else {
		factory(root.Zepto, root.IScroll, root.Hammer, root.lrz);
	}
